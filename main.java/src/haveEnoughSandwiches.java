...
You are preparing for a delightful summer picnic in the park and need to pack enough sandwiches for everyone. The sandwiches array represents the number of sandwiches each person wants. The totalSandwiches represents the total number of sandwiches you have prepared.
...
The function returns a boolean value. It should return true if you have enough sandwiches for everyone, and false if you don't have enough.
 */

class HaveEnoughSandwiches {
    public static boolean haveEnoughSandwiches(int[] sandwiches, int totalSandwiches) {
        int totalRequested = sum(sandwiches);
        return totalRequested <= totalSandwiches;
    }
